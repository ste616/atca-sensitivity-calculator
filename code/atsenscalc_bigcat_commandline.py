...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--subband-channels", type=int, default=128,
                        help="the number of channels per subband for the spectral output")
    parser.add_argument("-B", "--number-subbands", type=int, default=15,
                        help="the number of subbands in the spectral output")
    ...
    parser.add_argument("-W", "--zoom-bandwidth", default=2.0, type=float,
                        help="the bandwidth of a zoom band in MHz")
    ...
    parser.add_argument("-Z", "--zoom-channels", type=int, default=4096,
                        help="the number of channels in the zoom band before smoothing")
