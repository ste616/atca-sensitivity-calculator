require( [ 'dojo/dom', 'dojo/dom-attr', 'dojo/on', 'dojo/query', 'dojo/store/Memory',
	 ...
	 function(dom, domAttr, on, query, Memory, ComboBox, domClass, fx, domStyle, 
	     ...
	     var linkedElements = [
		 // Text input elements.
		 [ 'data-bigcat-centralfreq', 'interactive-continuum-bigcat-centralfreq' ],
		 [ 'data-bigcat-zoomfreq', 'interactive-bigcat-spectralfreq' ],
		 ...
		 '', '', '-30', '12', '6', '1', '1', '0', '720', '1',
		 // Radio buttons.
		 '6km', 'N', 'Integration', 'mJy/beam', 'continuum', 'best', 'ANNUAL',
		 // Checkboxes.
		 true, true
	     ];
		 ...
		 var href = "interactive_senscalc_help_bigcat.html#" + divShow;
		 ...
		 if (cId === 'data-bigcat-centralfreq' ||
		     cId === 'interactive-continuum-bigcat-centralfreq') {
		     if (!bandName(myVal)) {
			 myVal = '';
			 domAttr.set(cId, 'value', myVal);
	     ...
	     **/
		 ...
		 if (myId === 'data-bigcat-zoomfreq' ||
		     myId === 'interactive-bigcat-spectralfreq') {
		     // We automatically set a continuum frequency if required.
		     var cabbFreq = domAttr.get('data-bigcat-centralfreq', 'value');
		     var zoomFreq = domAttr.get('data-bigcat-zoomfreq', 'value');
		     if (zoomFreq === '') {
			 return;
		     }
		     ...
		     domAttr.set('data-bigcat-centralfreq', 'value', bestFreq);
		     domAttr.set('interactive-continuum-bigcat-centralfreq', 
				 'value', bestFreq);
		 }
	     };
		 ...
		 var currFreq = domAttr.get('interactive-continuum-bigcat-centralfreq',
					    'value');
		 ...
		 domAttr.set('interactive-continuum-bigcat-centralfreq', 'value',
			     bandContinuumFrequencies[band[1]][freqIndex]);
		 domAttr.set('data-bigcat-centralfreq', 'value',
			     bandContinuumFrequencies[band[1]][freqIndex]);
	     };
		...
		function(e) {
		 ...
		 return xhr('/cgi-bin/obstools/atsenscalc_bigcat_web.py', {
		     'data': pack,
		     'handleAs': 'json',
		     'method': 'POST'
		 });
		 ...
		 pack['frequency'] = domAttr.get('data-bigcat-centralfreq', 'value');
		 if (pack['frequency'] === '' ||
